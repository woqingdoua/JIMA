...
from modules.loss_rl import RewardCriterion
from models.r2gen import BaseCMNModel
...
def parse_agrs():
    ...
    parser.add_argument('--ann_path', type=str, default='/home/ywu10/Documents/R2Gen/data/mimic_cxr/annotation_label.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--log_period', type=int, default=10000, help='the logging interval (in batches).')
