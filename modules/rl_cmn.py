...
class Transformer(nn.Module):
    def __init__(self, encoder, decoder, src_embed, tgt_embed, cmn, norm):
...
class BaseCMN(AttModel):
    ...
    def make_model(self, tgt_vocab, cmn, norm_txt):
        c = copy.deepcopy
        ...
        model = Transformer(
            ...
            nn.Sequential(Embeddings(self.d_model, tgt_vocab), c(position)), cmn, norm_txt)
    ...
    def __init__(self, args, tokenizer):
        ...
        self.model = self.make_model(tgt_vocab, self.cmn, self.norm_txt)
